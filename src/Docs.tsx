...
const Docs = () => {
  ...
  return (
    <div className="settings-app-div">
      ...
      >
        <div className={"line2"}>
          <img src="/folder.png" alt="" className={"logo2"} />
          <p></p>
          <button className={"minimize2"}>-</button>
          <button className={"square2"}>
            <img src="/icons8-square-30.png" alt="" className={"square-icon"} />
          </button>
          <button onClick={Opener("/")} className={"cross2"}>
            X
          </button>
        </div>
        ...
        <div className={"file-menu"}>
          <p
            ...
            className={"homedr"}
            onClick={Opener("/home/denis")}
          >
            <img src="/home-button_icon-icons.com_72700.png" alt="" />
            Home
          </p>
          <p className={"docsdr"} style={{ backgroundColor: "lightgrey" }}>
        ...
        <div className={"tool-line"}>
          <input
            type="text"
            className={"nav-file-bar"}
            value={val}
            onChange={handleChangeInput}
            style={{ width: "470px" }}
          />
          <button className={"file-search-btn"} onClick={Opener(sval)}>
            <img src="/icons8-magnifying-glass-30.png" alt="" />
          </button>
        </div>
        <div className={"drcontent"}></div>
      </div>
    </div>
  );
};
